...
namespace Customers.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel obj,string url = "")
        {
            ...
            {
                obj.Password = CommonMethod.MD5EnCryptor(obj.Password + Shared.MD5_KEY);
        ...
        public ActionResult Register(CustomerViewModel obj, string ConfirmPassword)
        {
            ...
            using (var uow = new UnitOfWork(Shared.connString))
            {
                ...
                customer.Password = CommonMethod.MD5EnCryptor(obj.Password + Shared.MD5_KEY);
        ...
        public ActionResult ChangePassword(ChangePasswordViewModel obj)
        {
            ...
            obj.Password = CommonMethod.MD5EnCryptor(obj.Password + Shared.MD5_KEY);
            obj.NewPassword = CommonMethod.MD5EnCryptor(obj.NewPassword + Shared.MD5_KEY); ;
            obj.ConfirmNewPassword = CommonMethod.MD5EnCryptor(obj.ConfirmNewPassword + Shared.MD5_KEY); ;
