    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(CustomerViewModel obj, string ConfirmPassword)
        {
            ...
            using (var uow = new UnitOfWork(Shared.connString))
            {
                ...
                customer.Password = ExtendMethod.MD5EnCryptor(obj.Password + Shared.MD5_KEY);
        ...
        public ActionResult ChangePassword(ChangePasswordViewModel obj)
        {
            ...
            obj.Password = ExtendMethod.MD5EnCryptor(obj.Password + Shared.MD5_KEY);
            obj.NewPassword = ExtendMethod.MD5EnCryptor(obj.NewPassword + Shared.MD5_KEY); ;
            obj.ConfirmNewPassword = ExtendMethod.MD5EnCryptor(obj.ConfirmNewPassword + Shared.MD5_KEY); ;
